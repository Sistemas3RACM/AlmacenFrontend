...
<script>
import VerProductoScript from './VerProductoScript';
export default {
    ...VerProductoScript,
};
</script>
...
@media (max-width:750px) {
    ...
    .modal-content {
        margin: 10px;
        padding: 20px;
        /* Ajusta el padding para mantener un espacio interior adecuado */
        overflow-y: auto;
        /* Agrega desplazamiento vertical si el contenido excede la altura de la pantalla */
