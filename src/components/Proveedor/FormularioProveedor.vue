      ...
      <form @submit.prevent="guardarProveedor">
        <div class="mb-3">
          <div class=".col-xl-12 ">
            ...
            <input type="text" class="form-control" placeholder="Ingrese el nombre" v-model="proveedor.nombre" required>
          </div>
          <div class="col">
            <label class="form-label label-left">Dirección</label>
            <input type="text" class="form-control" placeholder="Ingrese la dirección" v-model="proveedor.direccion">
          </div>
          <div class="col">
            <label class="form-label label-left">Teléfono</label>
            <input type="text" class="form-control" placeholder="Ingrese el teléfono" v-model="proveedor.telefono">
          </div>
          <div class="col">
            <label class="form-label label-left">Información de contacto</label>
            <textarea class="form-control" placeholder="Ingrese la información del contacto"
              v-model="proveedor.infoContacto" rows="3"></textarea>
          </div>
          <div class="col">
            <label class="form-label label-left">Descripción del proveedor *</label>
            <textarea class="form-control" placeholder="Ingrese la descripción del proveedor"
              v-model="proveedor.descripcion" rows="3" required></textarea>
          </div>
