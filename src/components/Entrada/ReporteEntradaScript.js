import { API_REQUISICIONES_URL, API_URL, ENDPOINT_CONSULTAR_PRODUCTO, ENDPOINT_LISTAR_CUENTAS, ENDPOINT_LISTAR_PRODUCTOS, ENDPOINT_LISTAR_PROVEEDORES } from "@/keys";
