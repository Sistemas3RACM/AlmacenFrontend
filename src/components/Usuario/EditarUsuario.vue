        ...
        <div class="modal-content">
            ...
            <form @submit.prevent="enviarUsuario">
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" aria-label="default input example" v-model="usuario.nombre"
                        required>
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Correo:</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                        v-model="usuario.correo" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" aria-label="Default select example" v-model="usuario.puesto"
                        required>
                ...
                <div class="mb-3 d-flex justify-content-between">
                    <a class="btn m-1 col-5 btn-danger" @click="closeModal">Cerrar</a>
                    <button type="submit" class="btn m-1 col-5 btn-primary">Actualizar</button>
                </div>
            </form>
        </div>
    </div>
...
export default {
    ...
    methods: {
        ...
        enviarUsuario() {
            this.$emit('guardar-cambios', this.usuario);
            this.show = false;
        },
    },
};
